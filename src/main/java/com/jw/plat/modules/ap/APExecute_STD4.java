 ...
 */
public class APExecute_STD4 implements BaseExecute {

    public DataSet<Row> run(ExecutionEnvironment env) throws RuntimeException {

        DataSet<Row> input1 = null;
        CsvReader csvReader = env.readCsvFile(Constants.OUTPATH + File.separator + Constants.APSTD3 + "-" + Constants.batch);
        input1 = csvReader.includeFields("1111111111111111111111")
                .lineDelimiter("\n")
                .fieldDelimiter(",")
                .ignoreInvalidLines()
                ...
                .with(new JoinFunction<Tuple22<String, String, String, String, String, String, String, String, String, String, String, String, String, String,String, String, String, String, String, String, String, String>,
                        ...
                        Row>() {
                    @Override
                    public Row join(Tuple22<String, String, String, String, String, String, String, String, String, String, String, String, String, String,String, String, String, String, String, String, String, String> t1, Tuple7<String, String, String, String, String, String, String> t2) throws Exception {
