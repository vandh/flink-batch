 ...
 */
public class APExecute_STD3 implements BaseExecute {

    public DataSet<Row> run(ExecutionEnvironment env) throws RuntimeException {


        DataSet<Row> input1 = null;
        CsvReader csvReader = env.readCsvFile(Constants.OUTPATH + File.separator + Constants.APSTD2 + "-" + Constants.batch);
        input1 = csvReader.includeFields("11111111111111")
                .lineDelimiter("\n")
                .fieldDelimiter(",")
                .ignoreInvalidLines()
                ...
                .join(PO_VENDOR_SITES_ALL.proc(env))
                .where(5)
                .equalTo(0)
               ...
               .join(AP_XLA_DIS_LINKS.proc(env))
                ...
                .with(new JoinFunction<Tuple17<String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String>,
                    ...
                    public Row join(
                        ...
                        return Rows.create(t1, t2, new int[]{0, 1, 2, 3});
                    }
                })

                .join(AP_XLA_AE_HEADERS.proc(env))
                .where(new Selectors2(new int[]{18,17}))
                .equalTo(0,1)
                .with(new JoinFunction<Row, Tuple3<String, String, String>, Row>(){
                    @Override
                    public Row join(Row t1, Tuple3<String, String, String> t2) throws Exception {
